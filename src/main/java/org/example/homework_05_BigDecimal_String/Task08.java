...
public class Task08 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        BigDecimal currentPrice, averagePrice = BigDecimal.ZERO;
        ...
        for (int i = 0; i < amountOfProducts; i++) {
            ...
            averagePrice = averagePrice.add(currentPrice);
        }
        System.out.print("Average price is " + averagePrice.divide(BigDecimal.valueOf(amountOfProducts), 2, RoundingMode.HALF_UP));
    }
}
